...
public final class AppRate {
    ...
    private int AppLaunchedRemindInterval = 0;
    ...
    public void showRateDialog(Activity activity) {
        if (!activity.isFinishing()) {
            new DialogManager(activity, options);
        }
    }
    ...
    public AppRate setAppLaunchedTimesRemindInterval(int remindInterval) {
        this.AppLaunchedRemindInterval = remindInterval;
        return this;
    }

    public boolean isOverAppLaunchedRemind(){
        return getAppLaunchedTimes(context) >= AppLaunchedRemindInterval;
    }
}
